...
const
{
	...
	if(global_data->get_use_manufactured_solution())
	{
		...
		eval_time = global_data->get_t_ref();
		if(get_values_and_derivatives(e_omega_ref_sets[1], x, h_omega_manufactured, h_omega_1_manufactured_0, h_omega_2_manufactured, make_tuple(true, true, false)))
			return true;
...
const
{
	...
	if(global_data->get_use_manufactured_solution())
	{
		...
		h_omega_1_manufactured_0 = 0.0;
		eval_time = global_data->get_t_ref();
		if(get_values_and_derivatives(e_sigma_ref_sets[1], x, n, h_omega_manufactured, h_omega_1_manufactured_0, h_omega_2_manufactured, make_tuple(true, true, false)))
			return true;
