...
\item 
void \mbox{\hyperlink{classincremental_f_e_1_1_f_e_model_a9ebab6e6405f1ea373bc3958b3f27464}{set\+\_\+solution}} (const Solution\+Vector\+Type \&\mbox{\hyperlink{classincremental_f_e_1_1_f_e_model_a02134975db38fcf4f7ce698d605baa30}{solution}})
\item 
...
\item 
void \mbox{\hyperlink{classincremental_f_e_1_1_f_e_model_aea2ab158ff4d489df2773bb23159f200}{set\+\_\+manufactured\+\_\+solution}} (\mbox{\hyperlink{classincremental_f_e_1_1_manufactured_solution}{Manufactured\+Solution}}$<$ Solution\+Vector\+Type $>$ $\ast$\mbox{\hyperlink{classincremental_f_e_1_1_f_e_model_abfa82cec71c452b3f880c9db0229601c}{manufactured\+\_\+solution}}, const double \mbox{\hyperlink{classincremental_f_e_1_1_f_e_model_a2f120dec98a00102c846099dcc3db015}{alpha\+\_\+manufactured}})
...
\item 
bool \mbox{\hyperlink{classincremental_f_e_1_1_f_e_model_ab733923a16cd40238221b021a021f5c4}{compute\+\_\+system}} (const std\+::vector$<$ const Solution\+Vector\+Type $\ast$ $>$ solution\+\_\+ref\+\_\+sets, dealii\+::\+Affine\+Constraints$<$ double $>$ \&\mbox{\hyperlink{classincremental_f_e_1_1_f_e_model_a33a622c3c53ea4bee3bdefac06201c70}{constraints}}, const bool first\+\_\+assembly=false)
\item 
...
\item 
\mbox{\hyperlink{classincremental_f_e_1_1_manufactured_solution}{Manufactured\+Solution}}$<$ Solution\+Vector\+Type $>$ $\ast$ \mbox{\hyperlink{classincremental_f_e_1_1_f_e_model_abfa82cec71c452b3f880c9db0229601c}{manufactured\+\_\+solution}} = nullptr
\item 
double \mbox{\hyperlink{classincremental_f_e_1_1_f_e_model_a2f120dec98a00102c846099dcc3db015}{alpha\+\_\+manufactured}} = 0.\+5
\end{DoxyCompactItemize}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{classincremental_f_e_1_1_f_e_model_ab733923a16cd40238221b021a021f5c4}\label{classincremental_f_e_1_1_f_e_model_ab733923a16cd40238221b021a021f5c4}} 
...
{\footnotesize\ttfamily template$<$unsigned int spacedim, class Solution\+Vector\+Type , class R\+H\+S\+Vector\+Type , class Matrix\+Type $>$ \\
bool \mbox{\hyperlink{classincremental_f_e_1_1_f_e_model}{incremental\+F\+E\+::\+F\+E\+Model}}$<$ spacedim, Solution\+Vector\+Type, R\+H\+S\+Vector\+Type, Matrix\+Type $>$\+::compute\+\_\+system (\begin{DoxyParamCaption}\item[{const std\+::vector$<$ const Solution\+Vector\+Type $\ast$ $>$}]{solution\+\_\+ref\+\_\+sets,  }\item[{dealii\+::\+Affine\+Constraints$<$ double $>$ \&}]{constraints,  }\item[{const bool}]{first\+\_\+assembly = {\ttfamily false} }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em solution\+\_\+ref\+\_\+sets} & The reference solution vectors\\
\hline
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{classincremental_f_e_1_1_f_e_model_aea2ab158ff4d489df2773bb23159f200}\label{classincremental_f_e_1_1_f_e_model_aea2ab158ff4d489df2773bb23159f200}} 
\index{incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$@{incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$}!set\_manufactured\_solution@{set\_manufactured\_solution}}
\index{set\_manufactured\_solution@{set\_manufactured\_solution}!incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$@{incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$}}
\doxysubsubsection{\texorpdfstring{set\_manufactured\_solution()}{set\_manufactured\_solution()}}
{\footnotesize\ttfamily template$<$unsigned int spacedim, class Solution\+Vector\+Type , class R\+H\+S\+Vector\+Type , class Matrix\+Type $>$ \\
void \mbox{\hyperlink{classincremental_f_e_1_1_f_e_model}{incremental\+F\+E\+::\+F\+E\+Model}}$<$ spacedim, Solution\+Vector\+Type, R\+H\+S\+Vector\+Type, Matrix\+Type $>$\+::set\+\_\+manufactured\+\_\+solution (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classincremental_f_e_1_1_manufactured_solution}{Manufactured\+Solution}}$<$ Solution\+Vector\+Type $>$ $\ast$}]{manufactured\+\_\+solution,  }\item[{const double}]{alpha\+\_\+manufactured }\end{DoxyParamCaption})}


\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em manufactured\+\_\+solution} & Object representing the manufactured solution.\\
\hline
\mbox{\texttt{ in}}  & {\em alpha\+\_\+manufactured} & The value of alpha used for the evaluation of the manufactured solution at the intermediate point during a time increment. Needs to be consistent with what is prescribed in the scalar functionals. \\
\hline
\end{DoxyParams}
\mbox{\Hypertarget{classincremental_f_e_1_1_f_e_model_a9ebab6e6405f1ea373bc3958b3f27464}\label{classincremental_f_e_1_1_f_e_model_a9ebab6e6405f1ea373bc3958b3f27464}} 
\index{incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$@{incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$}!set\_solution@{set\_solution}}
\index{set\_solution@{set\_solution}!incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$@{incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$}}
\doxysubsubsection{\texorpdfstring{set\_solution()}{set\_solution()}}
{\footnotesize\ttfamily template$<$unsigned int spacedim, class Solution\+Vector\+Type , class R\+H\+S\+Vector\+Type , class Matrix\+Type $>$ \\
void \mbox{\hyperlink{classincremental_f_e_1_1_f_e_model}{incremental\+F\+E\+::\+F\+E\+Model}}$<$ spacedim, Solution\+Vector\+Type, R\+H\+S\+Vector\+Type, Matrix\+Type $>$\+::set\+\_\+solution (\begin{DoxyParamCaption}\item[{const Solution\+Vector\+Type \&}]{solution }\end{DoxyParamCaption})}

Sets the solution vector


\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em solution} & The solution to be set.\\
\hline
\end{DoxyParams}
\begin{DoxyWarning}{Warning}
This function does nothing apart from setting the solution vector. It is the user\textquotesingle{}s responsibility that the \mbox{\hyperlink{classincremental_f_e_1_1_f_e_model}{F\+E\+Model}} is left in a usable state afterwards. In particular, no checking for the size of the solution vector or for the satisfaction of constraints is done. Also, this function does not read in the values of the hidden variables at the material points. Essentially, the purpose of this function is to make a computed solution available for post-\/processing without having to repeat the entire solution process. In particular, this function is not meant for restarting an analysis at a certain point. 
\end{DoxyWarning}
...
Matrix with all combined constraints (used internally during the solution process) \mbox{\Hypertarget{classincremental_f_e_1_1_f_e_model_a2f120dec98a00102c846099dcc3db015}\label{classincremental_f_e_1_1_f_e_model_a2f120dec98a00102c846099dcc3db015}} 
\index{incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$@{incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$}!alpha\_manufactured@{alpha\_manufactured}}
\index{alpha\_manufactured@{alpha\_manufactured}!incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$@{incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$}}
\doxysubsubsection{\texorpdfstring{alpha\_manufactured}{alpha\_manufactured}}
{\footnotesize\ttfamily template$<$unsigned int spacedim, class Solution\+Vector\+Type , class R\+H\+S\+Vector\+Type , class Matrix\+Type $>$ \\
double \mbox{\hyperlink{classincremental_f_e_1_1_f_e_model}{incremental\+F\+E\+::\+F\+E\+Model}}$<$ spacedim, Solution\+Vector\+Type, R\+H\+S\+Vector\+Type, Matrix\+Type $>$\+::alpha\+\_\+manufactured = 0.\+5\hspace{0.3cm}{\ttfamily [private]}}

The value of alpha used for the evaluation of the manufactured solution at the intermediate point during a time increment. Needs to be consistent with what is prescribed in the scalar functionals. \mbox{\Hypertarget{classincremental_f_e_1_1_f_e_model_a937ea806f50796c76a45f36e6ec3cd29}\label{classincremental_f_e_1_1_f_e_model_a937ea806f50796c76a45f36e6ec3cd29}} 
...
determines whether hanging node constraints are taken into account or ignored \mbox{\Hypertarget{classincremental_f_e_1_1_f_e_model_abfa82cec71c452b3f880c9db0229601c}\label{classincremental_f_e_1_1_f_e_model_abfa82cec71c452b3f880c9db0229601c}} 
\index{incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$@{incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$}!manufactured\_solution@{manufactured\_solution}}
\index{manufactured\_solution@{manufactured\_solution}!incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$@{incrementalFE::FEModel$<$ spacedim, SolutionVectorType, RHSVectorType, MatrixType $>$}}
\doxysubsubsection{\texorpdfstring{manufactured\_solution}{manufactured\_solution}}
{\footnotesize\ttfamily template$<$unsigned int spacedim, class Solution\+Vector\+Type , class R\+H\+S\+Vector\+Type , class Matrix\+Type $>$ \\
\mbox{\hyperlink{classincremental_f_e_1_1_manufactured_solution}{Manufactured\+Solution}}$<$Solution\+Vector\+Type$>$$\ast$ \mbox{\hyperlink{classincremental_f_e_1_1_f_e_model}{incremental\+F\+E\+::\+F\+E\+Model}}$<$ spacedim, Solution\+Vector\+Type, R\+H\+S\+Vector\+Type, Matrix\+Type $>$\+::manufactured\+\_\+solution = nullptr\hspace{0.3cm}{\ttfamily [private]}}

This holds an object representing the manufactured solution. \mbox{\Hypertarget{classincremental_f_e_1_1_f_e_model_ac5c2edc96caa3b5ca1e55a655c56873e}\label{classincremental_f_e_1_1_f_e_model_ac5c2edc96caa3b5ca1e55a655c56873e}} 
