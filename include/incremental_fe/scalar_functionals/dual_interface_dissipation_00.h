#ifndef INCREMENTALFE_SCALARFUNCTIONALS_DUALINTERFACEDISSIPATION00_H_
#define INCREMENTALFE_SCALARFUNCTIONALS_DUALINTERFACEDISSIPATION00_H_
 ...
 *
 * \f$h^\Sigma_\tau = -\Delta t \dfrac{d}{2} \dfrac{\Delta \eta^2}\f$,
 *
 * In these equations \f$\Delta t\f$ is the length of the time step.
 *
 * The quantity \f$\Delta \eta\f$ is the driving force for the flux through the interface.
 *
...
class
DualInterfaceDissipation00:public dealii::GalerkinTools::ScalarFunctional<spacedim-1, spacedim>
{
...
public:
	 ...
	 */
	DualInterfaceDissipation00(	const std::vector<dealii::GalerkinTools::DependentField<spacedim-1,spacedim>>	e_sigma,
...
#endif /* INCREMENTALFE_SCALARFUNCTIONALS_DUALINTERFACEDISSIPATION00_H_ */
