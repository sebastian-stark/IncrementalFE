#ifndef INCREMENTALFE_SCALARFUNCTIONALS_NEOHOOKE01_H_
#define INCREMENTALFE_SCALARFUNCTIONALS_NEOHOOKE01_H_
...
/**
 * Class defining Neo-Hooke material for hydrogel modeling (material with "compression point"),
 * see Acartürk2009: Simulation of Charged Hydrated Porous Materials, Eq. (3.99)
 *
...
class
NeoHooke01:public dealii::GalerkinTools::ScalarFunctional<spacedim, spacedim>
{
...
private:
	...
	/**
	 * Initial solid volume fraction (defines "compression point")
	 */
	const double
	n_0;
...
public:
	 ...
	 *
	 * @param[in]		global_data				NeoHooke01::global_data
	 *
	 * @param[in]		lambda					NeoHooke01::lambda
	 *
	 * @param[in]		mu						NeoHooke01::mu
	 *
	 * @param[in]		n_0						NeoHooke01::n_0
	 *
	 * @param[in]		alpha					NeoHooke01::alpha
	 */
	NeoHooke01(const std::vector<dealii::GalerkinTools::DependentField<spacedim,spacedim>>	e_omega,
...
#endif /* INCREMENTALFE_SCALARFUNCTIONALS_NEOHOOKE01_H_ */
