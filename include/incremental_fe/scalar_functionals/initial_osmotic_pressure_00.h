#ifndef INCREMENTALFE_SCALARFUNCTIONALS_INITIALOSMOTICPRESSURE00_H_
#define INCREMENTALFE_SCALARFUNCTIONALS_INITIALOSMOTICPRESSURE00_H_
...
/**
 * Class defining an initial pressure to compensate for initial osmotic pressure
 *
...
class
InitialOsmoticPressure00:public dealii::GalerkinTools::ScalarFunctional<spacedim, spacedim>
{
...
public:
	 ...
	 *
	 * @param[in]		global_data				InitialOsmoticPressure00::global_data
	 *
	 * @param[in]		p_0						InitialOsmoticPressure00::p_0
	 *
	 * @param[in]		alpha					InitialOsmoticPressure00::alpha
	 */
	InitialOsmoticPressure00(	const std::vector<dealii::GalerkinTools::DependentField<spacedim,spacedim>>	e_omega,
...
#endif /* INCREMENTALFE_SCALARFUNCTIONALS_INITIALOSMOTICPRESSURE00_H_ */
