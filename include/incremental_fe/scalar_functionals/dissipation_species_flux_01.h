#ifndef INCREMENTALFE_SCALARFUNCTIONALS_DISSIPATIONSPECIESFLUX01_H_
#define INCREMENTALFE_SCALARFUNCTIONALS_DISSIPATIONSPECIESFLUX01_H_
...
class
DissipationSpeciesFlux01:public dealii::GalerkinTools::ScalarFunctional<spacedim, spacedim>
{
...
public:
	 ...
	 *
	 * @param[in]		method					DissipationSpeciesFlux01::method
	 */
	DissipationSpeciesFlux01(	const std::vector<dealii::GalerkinTools::DependentField<spacedim,spacedim>>	e_omega,
...
#endif /* INCREMENTALFE_SCALARFUNCTIONALS_DISSIPATIONSPECIESFLUX01_H_ */
