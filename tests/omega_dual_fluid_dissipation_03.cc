...
check()
{
	...
	vector<DependentField<spacedim, spacedim>> dependent_fields(25 + 4*I, DependentField<spacedim, spacedim>("q"));
	...
	OmegaDualFluidDissipation03<spacedim> omega_dual_fluid_dissipation_03(	dependent_fields,
																			{},
																			QGauss<spacedim>(1),
																			global_data,
																			I,
	...
	omega_dual_fluid_dissipation_03.compare_derivatives_with_numerical_derivatives(	e_omega,
																					e_omega_ref_sets,
																					hidden_vars,
																					x);
}
