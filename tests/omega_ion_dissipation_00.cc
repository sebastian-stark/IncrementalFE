...
check(unsigned int method)
{
	...
	vector<DependentField<spacedim, spacedim>> dependent_fields(17, DependentField<spacedim, spacedim>("q"));
	...
	OmegaIonDissipation00<spacedim> omega_dual_ion_dissipation_00(	dependent_fields,
																	{},
																	QGauss<spacedim>(1),
																	global_data,
																	D,
