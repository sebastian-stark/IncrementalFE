...
check()
{
	vector<DependentField<spacedim, spacedim>> dependent_fields(14, DependentField<spacedim, spacedim>("q"));
	...
	DualDissipationSpeciesFlux01<spacedim> dissipation_species_flux(dependent_fields,
																	{},
																	QGauss<spacedim>(1),
																	global_data,
																	D,
