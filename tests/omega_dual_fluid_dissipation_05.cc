...
check(unsigned int method)
{
	...
	OmegaDualFluidDissipation05<spacedim> omega_dual_fluid_dissipation_05(	dependent_fields,
																			{},
																			QGauss<spacedim>(1),
																			global_data,
																			I,
	...
	omega_dual_fluid_dissipation_05.compare_derivatives_with_numerical_derivatives(	e_omega,
																					e_omega_ref_sets,
																					hidden_vars,
																					x,
																					"derivatives.dat");
