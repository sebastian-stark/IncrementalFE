...
check()
{
	...
	PsiNeoHookeLagrange00<spacedim> psi_neo_hooke_lagrange_00(	dependent_fields,
																{},
																QGauss<spacedim>(1),
																global_data,
																lambda,
	...
	psi_neo_hooke_lagrange_00.compare_derivatives_with_numerical_derivatives(e_omega,
																			e_omega_ref_sets,
																			hidden_vars,
																			x,
																			"derivatives.dat");
