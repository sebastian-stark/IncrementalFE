...
check()
{
	...
	vector<DependentField<spacedim, spacedim>> dependent_fields(11, DependentField<spacedim, spacedim>("q"));

	const double V_m_F = 0.5;
	...
	IncompressibilityConstraint00<spacedim> chemical_potential(	dependent_fields,
																{},
																QGauss<spacedim>(1),
																global_data,
																V_m_F,
