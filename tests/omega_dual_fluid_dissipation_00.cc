...
check(unsigned int method)
{
	...
	vector<DependentField<spacedim, spacedim>> dependent_fields(1 + 4 + 3*I + 10 + I, DependentField<spacedim, spacedim>("q"));
	...
	OmegaDualFluidDissipation00<spacedim> omega_dual_fluid_dissipation_00(	dependent_fields,
																			{},
																			QGauss<spacedim>(1),
																			global_data,
																			I,
