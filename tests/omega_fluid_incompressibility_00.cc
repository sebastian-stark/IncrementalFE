...
check(unsigned int method)
{
	...
	vector<DependentField<spacedim, spacedim>> dependent_fields(4 + 3 + 4 + 9, DependentField<spacedim, spacedim>("q"));
	...
	OmegaFluidIncompressibility00<spacedim> omega_fluid_incompressibility_00(dependent_fields,
																			{},
																			QGauss<spacedim>(1),
																			global_data,
																			V_m_f,
	...
	omega_fluid_incompressibility_00.compare_derivatives_with_numerical_derivatives(e_omega,
																					e_omega_ref_sets,
																					hidden_vars,
																					x,
																					"derivatives.dat");
