...
check(unsigned int method)
{
	...
	OmegaViscousDissipation00<spacedim> omega_viscous_dissipation_00(	dependent_fields,
																		{},
																		QGauss<spacedim>(1),
																		global_data,
																		A,
	...
	omega_viscous_dissipation_00.compare_derivatives_with_numerical_derivatives(e_omega,
																				e_omega_ref_sets,
																				hidden_vars,
																				x);
}
