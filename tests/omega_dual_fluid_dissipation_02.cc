...
check()
{
	...
	vector<DependentField<spacedim, spacedim>> dependent_fields(22 + 4*I, DependentField<spacedim, spacedim>("q"));
	...
	OmegaDualFluidDissipation02<spacedim> omega_dual_fluid_dissipation_02(	dependent_fields,
																			{},
																			QGauss<spacedim>(1),
																			global_data,
																			I,
	...
	omega_dual_fluid_dissipation_02.compare_derivatives_with_numerical_derivatives(	e_omega,
																					e_omega_ref_sets,
																					hidden_vars,
																					x);
}
