...
check()
{
	vector<DependentField<spacedim, spacedim>> dependent_fields(23, DependentField<spacedim, spacedim>("q"));
	...
	DualFluidDissipation01<spacedim> dissipation_species_flux(	dependent_fields,
																{},
																QGauss<spacedim>(1),
																global_data,
																method);
