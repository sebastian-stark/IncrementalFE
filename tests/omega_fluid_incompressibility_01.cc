...
check(unsigned int method)
{
	...
	vector<DependentField<spacedim, spacedim>> dependent_fields(29, DependentField<spacedim, spacedim>("q"));
	...
	OmegaFluidIncompressibility01<spacedim> omega_fluid_incompressibility_01(dependent_fields,
																			{},
																			QGauss<spacedim>(1),
																			global_data,
																			V_m_f,
	...
	omega_fluid_incompressibility_01.compare_derivatives_with_numerical_derivatives(e_omega,
																					e_omega_ref_sets,
																					hidden_vars,
																					x,
																					"derivatives.dat");
