...
check()
{
	vector<DependentField<spacedim-1, spacedim>> dependent_fields(3, DependentField<spacedim-1, spacedim>("q"));
	...
	InterfaceDissipation01<spacedim> dissipation_species_flux(	dependent_fields,
																{},
																QGauss<spacedim-1>(1),
																global_data,
																alpha,
