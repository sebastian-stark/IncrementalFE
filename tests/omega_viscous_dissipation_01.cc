...
check(unsigned int method)
{
	...
	OmegaViscousDissipation01<spacedim> omega_viscous_dissipation_01(	dependent_fields,
																		{},
																		QGauss<spacedim>(1),
																		global_data,
																		A,
	...
	omega_viscous_dissipation_01.compare_derivatives_with_numerical_derivatives(e_omega,
																				e_omega_ref_sets,
																				hidden_vars,
																				x, "derivatives.dat");
}
