...
check(unsigned int method)
{
	...
	vector<DependentField<spacedim, spacedim>> dependent_fields(28, DependentField<spacedim, spacedim>("q"));
	...
	OmegaFluidIncompressibility03<spacedim> omega_fluid_incompressibility_03(dependent_fields,
																			{},
																			QGauss<spacedim>(1),
																			global_data,
																			V_m_f,
	...
	omega_fluid_incompressibility_03.compare_derivatives_with_numerical_derivatives(e_omega,
																					e_omega_ref_sets,
																					hidden_vars,
																					x,
																					"derivatives.dat");
