...
check()
{
	vector<DependentField<spacedim, spacedim>> dependent_fields(13, DependentField<spacedim, spacedim>("q"));
	...
	DissipationSpeciesFlux01<spacedim> dissipation_species_flux(dependent_fields,
																{},
																QGauss<spacedim>(1),
																global_data,
																D,
