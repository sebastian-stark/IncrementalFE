...
check(unsigned int method)
{
	...
	vector<DependentField<spacedim, spacedim>> dependent_fields(16, DependentField<spacedim, spacedim>("q"));
	...
	OmegaDualIonDissipation00<spacedim> omega_dual_ion_dissipation_00(	dependent_fields,
																		{},
																		QGauss<spacedim>(1),
																		global_data,
																		D,
	...
	omega_dual_ion_dissipation_00.compare_derivatives_with_numerical_derivatives(	e_omega,
																					e_omega_ref_sets,
																					hidden_vars,
																					x);
}
